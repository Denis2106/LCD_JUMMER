...
void ui_BEGIN_screen_init(void)
{
    ...
    lv_img_set_src(ui_dowmpic, &ui_img_1614410570);
    lv_obj_set_width(ui_dowmpic, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_dowmpic, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_size(ui_dowmpic, 106, 14);
    lv_obj_set_pos(ui_dowmpic, 107, 125);
...
void ui_MENU_screen_init(void)
{
    ...
    lv_obj_set_style_bg_img_src(ui_MENU, &ui_img_320x240_r0_28_png, LV_PART_MAIN | LV_STATE_DEFAULT);
